...
def test(
    ...
    if save_json and map and len(jdict):
        ...
        cocoGt = COCO('/data_1/shenty/coco/annotations/instances_val2014.json')  # initialize COCO ground truth api
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/data_1/shenty/yolo_model/normal_weights/best.pt', help='path to weights file')
