...
def train(
    ...
    init_seeds()
    weights = '/data_1/shenty/yolo_model/normal_weights' + os.sep
    ...
    for epoch in range(start_epoch, epochs):
        ...
        # Write epoch results
        with open('results_normal.txt', 'a') as file:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch-size', type=int, default=50, help='size of each image batch')
    ...
    parser.add_argument('--dist-url', default='tcp://127.0.0.1:9998', type=str, help='distributed training init method')
